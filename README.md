# Picovoice SDK for Arduino boards - Russian language
...
1. Compile and upload the `Picovoice_RU/GetUUID` sketch from the `File -> Examples` menu. Copy the UUID of the board
